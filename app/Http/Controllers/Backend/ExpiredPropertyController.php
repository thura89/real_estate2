...
class ExpiredPropertyController extends Controller
{
    public function index()
    {
        ...
        return view('backend.expired_property.index', compact('regions'));
    }
    public function ssd(Request $request)
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('action', function ($each) {
                $edit_icon = '<a href="" data-id="' . $each->id . '" class="expired badge badge-pill badge-info text-white" data-toggle="tooltip" data-placement="top" title="Tooltip on top">Renew</a>';
    ...
    public function destroy($id)
    {
        ...
        $property->delete();
        return redirect()->route('admin.expired_property.index')->with('delete', 'Successfully Deleted');
    }
    public function expired($id)
    {
        ...
        $property->update();
        return redirect()->route('admin.expired_property.index')->with('success', 'Successfully Extended');
    }
