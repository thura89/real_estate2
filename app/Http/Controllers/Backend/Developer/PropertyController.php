...
class PropertyController extends Controller
{
    public function index()
    {
        ...
        return view('backend.developer.property.index', compact('regions'));
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($category == 1 || $category == 6) {
            return view('backend.developer.property.create.house_shop', compact('regions', 'category', 'type'));
        }
        /* House Land, Land, Industrial */
        if ($category == 2 || $category == 5 || $category == 7) {
            return view('backend.developer.property.create.land_house_land', compact('regions', 'category', 'type'));
        }
        /* Apartment Condo , Office */
        if ($category == 3 || $category == 4) {
            return view('backend.developer.property.create.apartment_condo_office', compact('regions', 'category', 'type'));
        }
        return back();
    }
    /* Create House, Shop */
    public function house_shop_create(Request $request)
    {
        ...
        try {
            ...
            $property->developer_id = Auth()->user()->id;
            ...
            DB::commit();
            return redirect()->route('developer.property.index')->with('create', 'Successfully Created');
        } catch (\Exception $e) {
            DB::rollBack();
            // return $e;
    ...
    public function edit(Request $request, $id)
    {
        ...
        /* House , Shoop */
        if ($category == 1 || $category == 6) {
            return view('backend.developer.property.edit.house_shop', compact('id', 'property', 'regions', 'category', 'images'));
        }
        /* Land , House Land , Industiral */
        if ($category == 2 || $category == 5 || $category == 7) {
            return view('backend.developer.property.edit.landhouse_land', compact('id', 'property', 'regions', 'category', 'images'));
        }
        /* Aparment Condo and Office */
        if ($category == 3 || $category == 4) {
            return view('backend.developer.property.edit.apartment_condo_office', compact('id', 'property', 'regions', 'category', 'images'));
        }
