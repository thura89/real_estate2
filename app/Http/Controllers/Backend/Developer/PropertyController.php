...
class PropertyController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('backend.developer.property.create', compact('regions', 'category', 'type'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.developer.property.edit', compact('id', 'property', 'regions', 'category', 'images'));
    }
    ...
    public function PropertyUpdate(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            return back()->withErrors(['fail' => $e])->withInput();
        }
    }
    /* Create House, Shop */
