...
class NewProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.developer.new_project.index', compact('regions'));
    }
    ...
    {
        $regions = Region::get(['name', 'id']);
        return view('backend.developer.new_project.create', compact('regions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.developer.new_project.edit', compact('id', 'regions', 'data'));
    }
