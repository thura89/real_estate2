...
class DumpUserController extends Controller
{
    public function index()
    {
        return view('backend.dump-user.index');
    }
    public function ssd()
    {
    ...
    public function create(){
        return view('backend.dump-user.create');
    }
    public function store(CreateDeveloperUserRequest $request){
        ...
        $developerUser->save();
        return redirect()->route('admin.dump-user.index')->with('create', 'Successfully Created');
    }
    public function edit($id){
        $developerUser = User::findOrFail($id);
        return view('backend.dump-user.edit',compact('developerUser'));
    }
    public function update($id, UpdateDeveloperUserRequest $request){
        ...
        return redirect()->route('admin.dump-user.index')->with('update', 'Successfully Updated');
    }
