...
class DeveloperLoginController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = RouteServiceProvider::DEVELOPER;
    ...
    {
        $this->middleware('guest:developer_user')->except('logout');
    }
    ...
    {
        return Auth::guard('developer_user');
    }
    ...
    {
        $this->guard('developer_user')->logout();
