                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <select name="shop_type" class="form-control">
                                            ...
                                            @foreach (config('const.shop_type') as $key => $type)
                                                <option value="{{ $key }}"
                                                    @if ($property->situation->shop_type == $key) selected @endif>
                                                    {{ $type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <fieldset class="position-relative form-group">
                                            <div class="position-relative form-check">
                                                <label class="form-check-label">
                                                    <input name="water" type="radio" class="form-check-input"
                                                        value="1" @if ($property->suppliment->water_sys == 1) checked @endif>
                                                    Yes
                                                </label>
                                            </div>
                                            <div class="position-relative form-check">
                                                <label class="form-check-label">
                                                    <input name="water" type="radio" class="form-check-input"
                                                        value="0" @if ($property->suppliment->water_sys == 0) checked @endif>
                                                    No
                                                </label>
                                            </div>
                                        </fieldset>
                                    ...
                                    <div class="col form-group">
                                        ...
                                        <fieldset class="position-relative form-group">
                                            <div class="position-relative form-check">
                                                <label class="form-check-label">
                                                    <input name="electric" type="radio" class="form-check-input"
                                                        value="1" @if ($property->suppliment->electricity_sys == 1) checked @endif>
                                                    Yes
                                                </label>
                                            </div>
                                            <div class="position-relative form-check">
                                                <label class="form-check-label">
                                                    <input name="electric" type="radio" class="form-check-input"
                                                        value="0" @if ($property->suppliment->electricity_sys == 0) checked @endif>
                                                    No
                                                </label>
                                            </div>
                                        </fieldset>
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    ...
                                                    class="form-check-input"
                                                    @if ($property->buildingAmenity->elevator == 1) checked @endif>Elevator</label>
                                        </div>
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                        ...
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    ...
                                                    class="form-check-input"
                                                    @if ($property->buildingAmenity->fitness_center == 1) checked @endif>Fitness
                                                Center</label></div>
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    type="checkbox" name="security" value="1"
                                                    class="form-check-input"
                                                    @if ($property->buildingAmenity->security == 1) checked @endif>security</label>
                                        </div>
                                    </div>
                                    <div class="col form-group">
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                        ...
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    ...
                                                    class="form-check-input"
                                                    @if ($property->buildingAmenity->playground == 1) checked @endif>Playground</label>
                                        </div>
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                    ...
                                    <div class="col form-group">
                                        ...
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    ...
                                                    class="form-check-input"
                                                    @if ($property->buildingAmenity->own_transformer == 1) checked @endif>Own
                                                Transformer</label></div>
                                        <div class="position-relative form-check"><label class="form-check-label"><input
                                                    type="checkbox" name="disposal" value="1"
                                                    class="form-check-input"
                                                    @if ($property->buildingAmenity->disposal == 1) checked @endif>Disposal</label>
                                        </div>
