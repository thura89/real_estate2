            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('agent.property.update.house_shop') }}" class="form" method="POST"
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input value="{{ $property->areasize->front_area }}" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input value="{{ $property->areasize->fence_width }}" type="text"
                                                    name="fence_width" class="form-control">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="fence_length">Fence Length</label>
                                                <input value="{{ $property->areasize->fence_length }}" type="text"
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4 form-group">
                                <input name="status" type="checkbox" value="1" @if ($property->status == 1) checked @endif>
